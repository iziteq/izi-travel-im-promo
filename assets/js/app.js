$(document).ready(function() {
  ...
  // });
  tourDescriptionShort = $('[data-role="tourDescriptionShort"]');
  tourDescriptionFull = $('[data-role="tourDescriptionFull"]');
  tourDescriptionShow = $('[data-role="tourDescriptionShow"]');

  tourDescriptionShort.show();
  tourDescriptionFull.hide();

  tourDescriptionShow.on('click', function() {
    tourDescriptionShort.hide();
    tourDescriptionFull.show();
  });
});
